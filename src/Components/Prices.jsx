...
const hobbyFeatures = ['Up to 10.000$ with no fees', 'Team Access', '15 Transfers per week']
const scaleFeatures = ['Up to 150.000$ with no fees', 'Give access to anyone', '100 Transfers per week']
const growthFeatures = [
  'Up to 35.000$ with no fees',
  'Team/Friends Access',
  '75 Transfers per week',
  'Send now pay later',
  'Faster transfer priority',
]
    ...
    <div className="bg-gray-900">
      <div className="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
        <div className="text-center">
          ...
          At our company, we believe that everyone deserves the right price for our services, regardless of who they are. We strive to provide fair and transparent pricing for all our customers, without any hidden fees or charges.
          </p>
        </div>
      </div>
